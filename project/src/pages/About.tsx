  ...
  return (
    <div className="bg-black min-h-screen pt-16">
      ...
      <div className="relative h-[60vh] overflow-hidden">
        <img
          src="https://images.pexels.com/photos/1626544/pexels-photo-1626544.jpeg"
          alt="About Hero"
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="text-amber-400 text-xs tracking-[0.4em] uppercase mb-4">Nossa História</p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-screen-md mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="text-amber-400 text-xs tracking-[0.4em] uppercase mb-6">Manifesto</p>
      ...
      <section className="py-20 px-6 border-t border-neutral-900">
        <div className="max-w-screen-xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <p className="text-amber-400 text-xs tracking-[0.4em] uppercase mb-4">Nossos Valores</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              { title: 'Qualidade', text: 'Usamos materiais premium porque valorizamos o que carrega nossa mensagem. Excelência é uma forma de honrar o que acreditamos.' },
              ...
              >
                <div className="w-px h-12 bg-amber-400 mx-auto mb-6" />
      ...
      <section className="py-20 px-6">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="aspect-[4/3] overflow-hidden">
            <img src="https://files.catbox.moe/tl0kzc.jpeg" alt="Community" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="flex items-center">
            <div className="p-8">
              <p className="text-amber-400 text-xs tracking-[0.4em] uppercase mb-6">Nossa Visão</p>
              ...
              <Link to="/catalogo" className="inline-flex items-center gap-2 text-amber-400 text-xs tracking-[0.2em] uppercase hover:gap-4 transition-all duration-300">
